    ...
    public List<Student> parser(List<String> lines){
        ...
        for (int lineIndex = 0; lineIndex < lines.size(); lineIndex++){
            ...
            if (tokens[0].matches("\\d{8}")){
                ...
                //this loop keeps reading tokens until subject code is detected
                ...
                //this loop keeps reading tokens until internal grades are detected
                ...
                //this loop stores the internal grades until result is detected
                ...
                if (lineIndex + 1 >= lines.size() ) continue;
                String[] marksLine = lines.get(lineIndex + 1).trim().split("\\s+");
